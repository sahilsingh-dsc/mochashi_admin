    ...
    <div class="wrapper">
        ...
        <section class="gray-bg height-100vh d-flex align-items-center page-section-ptb ">
            ...
            <?php 
                        ...
                        <?php endif;?>
            <?php 
                        if (!empty($this->session->flashdata('signup_success'))): ?>
                            <!-- ERROR MESSAGE -->
                ...
                <div class="row no-gutters justify-content-center">
                    <div class="col-lg-4 col-md-6 login-fancy-bg bg-overlay-black-0">
                        <div class="login-fancy pos-r d-flex">
                            <div class="text-center w-100 align-self-center">
                                ...
                                <h2 class="mb-20" style="color:#3c5a99; font-weight: 500; font-family: cursive;">Mochashi</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 white-bg">
                        <div class="login-fancy pb-40 clearfix" id = "login_area">
                            ...
                            <form class="" action="<?php echo base_url();?>admin/signin" method="post">
                                <div class="section-field mb-20">
                                    <label class="mb-10" for="name">Username* </label>
                                    <input id="email" class="web form-control" type="text" placeholder="Username" name="username" required>
                                </div>
                                <div class="section-field mb-20">
                        ...
                        <div class="login-fancy pb-40 clearfix" id = "forgot_password_area" style="display: none;">
                            ...
                            <div class="section-field">
                                <div class="remember-checkbox mb-30">
                                    <a href="#" class="float-right" id = "login_button" onclick="toggleView(this)" style="color: black;">login ?</a>
                                </div>
                            </div>
                        </div>
                    </div>
