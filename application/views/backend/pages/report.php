        ...
        <div class="card">
            <div class="card-body">
				...
				<div class="row justify-content-md-center">
					...
					?>
					<input type="date" name="from_date" id="month" data-placeholder="Choose ..." value="<?=$from_date?>" />
					...
					<div class="col-4">
					    <input type="date" name="to_date" id="year" data-placeholder="Choose ..." value="<?=$to_date?>"/>
                ...
                <table id="basic-datatable" class="table dt-responsive nowrap" width="100%">
					...
					<tbody>
						...
						if(!empty($from_date) AND !empty($to_date)){
							...
							$subscriptions	=	$this->crud_model->get_subscription_report();
						}
							$counter 		=	1;
							$total_sale		=	0;
						...
						<tr>
							...
							<td>
							<a href="<?php echo base_url();?>admin/user_view/<?php echo $row['user_id'];?>" class="btn btn-primary btn-xs btn-mini">
								View</a>
							</td>
						</tr>
						<?php endforeach;?>
...
<script>
	function submit()
	{
		...
		window.location = "<?php echo base_url();?>admin/report/" + month + "/" + year;
	}
</script>
