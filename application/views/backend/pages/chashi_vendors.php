...
<div class="row justify-content-center">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Chashi Vendor List</h4>
                <table id="basic-datatable" class="table dt-responsive nowrap" width="100%">
					...
					<tbody>
						<?php
							$user = $this->db->get_where('user',  array('user_type' => 4))->result_array();
							$counter = 1;
							foreach ($user as $row): ?>
						<tr id="<?php echo $row['user_id'];?>">
							...
							<td style="vertical-align: middle;">
								 <a href="<?php echo base_url();?>admin/chashi_vendor_detail/<?php echo $row['user_id'];?>" class="btn btn-info btn-xs btn-mini"><i class="dripicons-preview"></i></a>
