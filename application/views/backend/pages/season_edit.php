<div class="row">
	<div class="col-md-6 col-sm-6 col-xs-6">
		<a href="<?php echo base_url();?>admin/series_edit/<?php echo $series_id;?>"
			class="btn btn-primary" style="clear:both;margin-bottom: 20px;" >
			<i class="mdi mdi-arrow-left-drop-circle-outline"></i>
			Back to series
		</a>
		<a href="<?php echo base_url();?>browse/playseries/<?php echo $series_id.'/'.$season_id;?>"
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								edit</a>
								<a href="<?php echo base_url();?>admin/episode_delete/<?php echo $series_id.'/'.$season_id.'/'.$episode_id;?>" 
...
<div id="create_episode_form" style="display: none;">
	<div class="grid simple ">
		...
		<div class="grid-body">
			<form method="post" action="<?php echo base_url();?>admin/episode_create/<?php echo $series_id.'/'.$season_id;?>"
...
<div id="edit_episode_form_<?php echo $row['episode_id'];?>" style="display: none;">
	<div class="grid simple ">
		...
		<div class="grid-body">
			<form method="post" action="<?php echo base_url();?>admin/episode_edit/<?php echo $series_id.'/'.$season_id.'/'.$episode_id;?>"
				enctype="multipart/form-data">
				<div class="form-group">
					<label class="form-label">Title</label>
					<span class="help"></span>
