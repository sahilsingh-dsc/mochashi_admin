				...
				<div class="col-md-6 col-12">
			        <div class="card">
			            <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                <label for="simpleinput90">Android App URL</label>
                                <input type="text" id="simpleinput90" class="form-control" name="android_url" value="<?php echo $android_url;?>">
                            </div>
                            <div class="form-group mb-3">
                                <label for="simpleinput9">IOS App URL</label>
                                <input type="text" id="simpleinput9" class="form-control" name="ios_url" value="<?php echo $ios_url;?>">
                            </div>
			            </div>
			        </div>
			    </div>
			        ...
			        <div class="card">
			            <div class="card-body">
							...
							<div class="form-group">
								...
								<span class="help"></span>
								<div class="controls">
									<input type="text" class="form-control" name="site_phone" value="<?= $site_phone; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<span class="help"></span>
								<div class="controls">
									<input type="text" class="form-control" name="site_fb_url" value="<?= $site_fb_url; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<span class="help"></span>
								<div class="controls">
									<input type="text" class="form-control" name="site_twitter_url" value="<?= $site_twitter_url; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<span class="help"></span>
								<div class="controls">
									<input type="text" class="form-control" name="site_gp_url" value="<?= $site_gp_url; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<span class="help"></span>
								<div class="controls">
									<input type="text" class="form-control" name="site_insta_url" value="<?= $site_insta_url; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<span class="help"></span>
								<div class="controls">
									<input type="text" class="form-control" name="website_url" value="<?= $website_url; ?>">
								</div>
							</div>
                            ...
                            <div class="form-group mb-3">
                                <label for="example-about_us">Website About Us</label>
                                <textarea class="form-control" id="example-about_us" name="about_us" rows="6"><?php echo $about_us;?></textarea>
                            </div>
			            </div>
			        </div>
			    </div>
