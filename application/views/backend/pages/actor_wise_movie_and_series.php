                       ...
                       <table id="" class="table dt-responsive nowrap" width="100%">
                            ...
                            $movies = $this->crud_model->get_actor_wise_movies_and_tv_series($actor_id, 'movie') ;
               						...
               						<tr>
               							...
               							<td style="vertical-align: middle;">
               								<a href="<?php echo base_url();?>browse/playmovie/<?php echo $row['movie_id'];?>"
               									target="_blank" class="btn btn-secondary btn-xs btn-mini">
               								<i class="fa fa-external-link"></i>visit</a>
               								<a href="<?php echo base_url();?>admin/movie_edit/<?php echo $row['movie_id'];?>" class="btn btn-info btn-xs btn-mini">
               								edit</a>
               								<a href="<?php echo base_url();?>admin/movie_delete/<?php echo $row['movie_id'];?>" class="btn btn-danger btn-xs btn-mini" onclick="return confirm('Want to delete?')">
               								delete</a>
               							</td>
               						</tr>
               						<?php endforeach;?>
                       ...
                       <table id="" class="table dt-responsive nowrap" width="100%">
                 					...
                 					<tbody>
                 						...
                 						<tr>
                 							...
                 							<td style="vertical-align: middle;">
                 								<a href="<?php echo base_url();?>browse/playseries/<?php echo $row['series_id'];?>"
                 									target="_blank" class="btn btn-secondary btn-xs btn-mini">
                 								<i class="fa fa-external-link"></i>visit</a>
                 								<a href="<?php echo base_url();?>admin/series_edit/<?php echo $row['series_id'];?>" class="btn btn-info btn-xs btn-mini">
                 								manage</a>
                 								<a href="<?php echo base_url();?>admin/series_delete/<?php echo $row['series_id'];?>" class="btn btn-danger btn-xs btn-mini" onclick="return confirm('Want to delete?')">
                 								delete</a>
                 							</td>
                 						</tr>
                 						<?php endforeach;?>
