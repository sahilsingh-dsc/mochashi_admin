						...
						<div class="col-xl-8 col-lg-9 col-md-12 col-sm-12 col-12">
		                  ...
		                  <!--   <input type="text" class="form-control" id = "name" name="name" value="<?php echo $genre_detail->name;?>"> -->
							...
							<div class="form-group">
								...
								<a href="<?php echo base_url();?>admin/grocery_vendors" class="btn btn-secondary">Go back</a>
							</div>
						</div>
					</div>
				</form>
...
<a href="<?php echo base_url();?>admin/grocery_category_create/<?php echo $user_id?>" class="btn btn-primary" style="margin-bottom: 20px;">
...
<div class="row justify-content-center">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title"><?php echo $vendor_details->fname;?> Category</h4>
                <table id="basic-datatable" class="table dt-responsive nowrap" width="100%">
					...
					<tbody>
						...
						<tr id="<?php echo $row['cat_id'];?>">
							...
							<td style="vertical-align: middle;">
					 <a href="<?php echo base_url();?>admin/grocery_vendor_products/<?php echo $row['cat_id'];?>/<?php echo $row['user_id'];?>" class="btn btn-info btn-xs btn-mini"><i class="dripicons-plus"></i></a>
							<a href="<?php echo base_url();?>admin/grocery_category_edit/<?php echo $row['cat_id'];?>" class="btn btn-success btn-xs btn-mini">
								manage</a>
				<!-- 	<a href="<?php echo base_url();?>admin/grocery_category_delete/<?php echo $row['cat_id'];?>/<?php echo $user_id;?>" class="btn btn-danger btn-xs btn-mini" onclick="return confirm('Want to delete?')">
								delete</a> -->
							</td>
						</tr>
						<?php endforeach;?>
