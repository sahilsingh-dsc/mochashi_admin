				...
				<div class="tab-content">
					...
					<div class="tab-pane box" id="add" style="padding: 30px">
		                <div class="box-content">
		                    <?php echo form_open(base_url() . 'admin/manage_language/add_phrase/' , array('class' => 'form-horizontal form-groups-bordered validate', 'style' => 'width:100%;'));?>
		                        <div class="padded">
					...
					<div class="tab-pane box" id="add_lang" style="padding: 30px">
		                <div class="box-content">
		                    <?php echo form_open(base_url() . 'admin/manage_language/add_language/' , array('class' => 'form-horizontal form-groups-bordered validate', 'style' => 'width:100%;'));?>
		                        <div class="padded">
		                            <div class="form-group">
