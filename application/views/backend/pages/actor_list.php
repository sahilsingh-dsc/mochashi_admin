<a href="<?php echo base_url();?>admin/banner_create/" class="btn btn-primary" style="margin-bottom: 20px;">
					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle;">
								<a href="<?php echo base_url();?>admin/banner_edit/<?php echo $row['actor_id'];?>" class="btn btn-info btn-xs btn-mini">
								edit</a>
								<a href="<?php echo base_url();?>admin/actor_delete/<?php echo $row['actor_id'];?>" class="btn btn-danger btn-xs btn-mini" onclick="return confirm('Want to delete?')">
								delete</a>
							</td>
						</tr>
						<?php endforeach;?>
