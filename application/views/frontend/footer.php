          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="mu-footer-widget">
                <h4>Contact</h4>
                <address>
                  <p>P.O. Box 320,MP 9495, India</p>
                  <p>Phone: (415) 453-1568 </p>
                  <p>Website: www.mochashi.com</p>
                  <p>Email: info@mochashi.io</p>
                </address>
              </div>
            </div>
          </div>
    ...
    <div class="mu-footer-bottom">
      <div class="container">
        <div class="mu-footer-bottom-area">
          <p>&copy; 2019 MoChashi. All Rights Reserved.<!--  <a href="http://www.markups.io/" rel="nofollow">MarkUps.io</a> --></p>
        </div>
      </div>
    </div>
    <!-- end footer bottom -->
